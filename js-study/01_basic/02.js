...
//문자열이 덧셈을 제외한 사칙연산이 있을 경우  숫자로 자동형변환
//이걸 응용하기보다는 디버그할때 참고하자
console.log(number1*number2);
console.log(number1/number2);
console.log(number1-number2);
console.log(number1+number2); //덧셈은 x(그저 숫자가 합쳐질뿐)
