...
//null병합 연산자
//A??B ->A가 null 혹은 undifined라면 B를 반환 아니면 A를 반환
...
let name=userInfo.porfile.name;
console.log(name);

userInfo={};
//undifined에 .으로 참조해서 에러발생!
//userInfo안에 profile이 있으면 참조, 없으면 defined 반환
//profiled안에 naem 이 있으면 참조, 없으면 undifined 반환
name=userInfo?.porfile?.name??"익명"
console.log(name);
